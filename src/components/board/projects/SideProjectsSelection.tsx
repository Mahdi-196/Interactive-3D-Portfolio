  ...
  return (
    <>
      ...
      >
        ...
        <Text position={[-1.5, 1.25, 0.042]} fontSize={0.16} color="#FFFFFF" anchorX="center" anchorY="middle">
          #01
        </Text>
        <Text position={[0, 0.7, 0.02]} fontSize={0.23} color={COLORS.darkBrown} anchorX="center" anchorY="middle">
          MedeSense
        </Text>
        <Text position={[0, 0.35, 0.02]} fontSize={0.12} color={COLORS.tertiaryText} anchorX="center" anchorY="middle" maxWidth={3.0}>
          AI Healthcare Chatbot
        </Text>
        <Text position={[0, 0.20, 0.02]} fontSize={0.12} color={COLORS.tertiaryText} anchorX="center" anchorY="middle" maxWidth={3.0}>
          HIPAA Compliant
        </Text>
        <Text position={[0, -0.15, 0.02]} fontSize={0.10} color={COLORS.brownText} anchorX="center" anchorY="middle">
          Next.js • AI/ML
        </Text>
        <Text position={[0, -0.30, 0.02]} fontSize={0.10} color={COLORS.brownText} anchorX="center" anchorY="middle">
          AWS • WebSocket
        </Text>
